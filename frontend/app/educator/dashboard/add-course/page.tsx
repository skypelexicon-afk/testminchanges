...
const AddCoursesPage = () => {
    ...
    const [contents, setContents] = useState<string[]>(['']); // what you will get
    ...
    const handleAddCourse = async () => {
        try {
            ...
            const data = await fetchApi.post<typeof payload, { courseId: number }>(
            ...
            if (error instanceof Error) {
                ...
                console.error('Unknown error creating course:', error);
    ...
    return (
        <div className="min-h-screen bg-gray-50 px-20 py-8">
            ...
            <div className="mt-6 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-6 mt-6">
                    <div className="flex flex-wrap gap-6">
                        ...
                        <div className="min-w-[1px]">
                            ...
                            <input
                                type="text"
                                value={educatorImage}
                                onChange={(e) => setEducatorImage(e.target.value)}
                    ...
                    <div>
                        ...
                        {demoVideoUrls.map((url, index) => (
                            <div key={index} className="flex items-center gap-2 mb-2">
                                ...
                                <button
                                    type="button"
                                    onClick={() => {
                                        const newUrls = demoVideoUrls.filter((_, i) => i !== index);
                                        setDemoVideoUrls(newUrls);
                                    }}
                        ...
                        <button
                            type="button"
                            onClick={() => setDemoVideoUrls([...demoVideoUrls, ''])}
                        ...
                        {contents.map((data, index) => (
                            <div key={index} className="flex items-center gap-2 mb-2">
                                ...
                                <button
                                    type="button"
                                    onClick={() => {
                                        const newData = contents.filter((_, i) => i !== index);
                                        setContents(newData);
                                    }}
                                    className="bg-red-500 text-white p-2 rounded hover:bg-red-700 hover:cursor-pointer"
                                >
                    ...
                    <div className="mt-6">
                        ...
                        {faqs.map((faq, index) => (
                            <div key={index} className="flex flex-col gap-2 mb-4 border border-gray-300 p-4 rounded-md">
                                <input
                                    type="text"
                                    value={faq.question}
                                    onChange={(e) => {
            ...
            <button
                ...
                className="mt-8 mx-4 bg-black text-white px-7 py-2 rounded shadow hover:bg-gray-900"
            >
                Add Course
            </button>
        </div>
